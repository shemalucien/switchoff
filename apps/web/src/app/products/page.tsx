        ...
        <>
            <div className="mt-0 dark:text-white dark:bg-gray-900">
                ...
                <div className="flex flex-col max-w-xl w-full mx-auto">
                    <h2 className="text-4xl font-bold text-center mb-8  dark:text-white dark:bg-gray-900 mt-24">Are you Ready to Taste our Products</h2>
                    <h3 className="text-base text-center mb-8  dark:text-white dark:bg-gray-900">Discover the perfect blend of flavors and textures that redefine your taste buds. Our drinks are crafted with the finest ingredients, designed to quench your thirst while delighting your palate. Experience the essence of our brand, where every sip is a journey of discovery.</h3>
                    {/* 
