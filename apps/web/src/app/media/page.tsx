...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  return (
    <div className={`relative bg-black rounded-lg overflow-hidden group ${className}`}>
      ...
      {/* Custom Controls */}
      {controls ? <div className="absolute inset-0 flex flex-col justify-between p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
          {/* Title Overlay */}
          <div>
